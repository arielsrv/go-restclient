...
// RawClient provides a mock function for the type MockHTTPClient
func (_mock *MockHTTPClient) RawClient(ctx context.Context) *http.Client {
...
func (_c *MockHTTPClient_RawClient_Call) Return(client *http.Client) *MockHTTPClient_RawClient_Call {
	_c.Call.Return(client)
	return _c
}

func (_c *MockHTTPClient_RawClient_Call) RunAndReturn(run func(ctx context.Context) *http.Client) *MockHTTPClient_RawClient_Call {
	_c.Call.Return(run)
	return _c
}
