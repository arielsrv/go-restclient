...
import (
	...
	z "github.com/dgraph-io/ristretto/v2/z"
)

// MockCache is an autogenerated mock type for the Cache type
type MockCache[K z.Key, V any] struct {
	mock.Mock
}

type MockCache_Expecter[K z.Key, V any] struct {
	mock *mock.Mock
}
...
type MockCache_Get_Call[K z.Key, V any] struct {
	*mock.Call
}
...
type MockCache_Set_Call[K z.Key, V any] struct {
	*mock.Call
}
...
type MockCache_SetWithTTL_Call[K z.Key, V any] struct {
	*mock.Call
}
...
func NewMockCache[K z.Key, V any](t interface {
	mock.TestingT
	Cleanup(func())
}) *MockCache[K, V] {
	mock := &MockCache[K, V]{}
