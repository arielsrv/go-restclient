...
on an Apple M1 Pro. Source: [`rest/benchmark_compare_test.go`](https://github.com/arielsrv/go-restclient/blob/main/rest/benchmark_compare_test.go).
...
| Example | Description |
|---|---|
| [`basic/`](https://github.com/arielsrv/go-restclient/blob/main/examples/basic/main.go) | Simple JSON GET + POST |
| [`generics/`](https://github.com/arielsrv/go-restclient/blob/main/examples/generics/main.go) | Typed deserialization with `rest.Deserialize[T]` |
| [`etag/`](https://github.com/arielsrv/go-restclient/blob/main/examples/etag/main.go) | ETag revalidation — unchanged (304) and content-changed (200 → force-update) |
| [`html/`](https://github.com/arielsrv/go-restclient/blob/main/examples/html/main.go) | Caching with `Last-Modified` |
| [`gzip/`](https://github.com/arielsrv/go-restclient/blob/main/examples/gzip/main.go) | Gzip transparent decompression |
| [`gzip_headers/`](https://github.com/arielsrv/go-restclient/blob/main/examples/gzip_headers/main.go) | Per-request `Accept-Encoding` |
| [`oauth/`](https://github.com/arielsrv/go-restclient/blob/main/examples/oauth/main.go) | OAuth2 Client Credentials (mock token server + mock API) |
| [`dfltheaders/`](https://github.com/arielsrv/go-restclient/blob/main/examples/dfltheaders/main.go) | Default + per-request headers |
| [`headers/`](https://github.com/arielsrv/go-restclient/blob/main/examples/headers/main.go) | Custom headers |
| [`xml/`](https://github.com/arielsrv/go-restclient/blob/main/examples/xml/main.go) | XML content type |
| [`form/`](https://github.com/arielsrv/go-restclient/blob/main/examples/form/main.go) | `application/x-www-form-urlencoded` |
| [`bytes/`](https://github.com/arielsrv/go-restclient/blob/main/examples/bytes/main.go) | Binary upload / large downloads |
| [`binary_download/`](https://github.com/arielsrv/go-restclient/blob/main/examples/binary_download/main.go) | Download a file to disk |
| [`str/`](https://github.com/arielsrv/go-restclient/blob/main/examples/str/main.go) | Raw string response handling |
| [`patch_options/`](https://github.com/arielsrv/go-restclient/blob/main/examples/patch_options/main.go) | PATCH and OPTIONS verbs |
| [`redirect/`](https://github.com/arielsrv/go-restclient/blob/main/examples/redirect/main.go) | Redirect handling |
| [`timeout/`](https://github.com/arielsrv/go-restclient/blob/main/examples/timeout/main.go) | Timeout configuration |
| [`ioc/`](https://github.com/arielsrv/go-restclient/blob/main/examples/ioc/main.go) | Dependency injection pattern |
| [`mock/`](https://github.com/arielsrv/go-restclient/blob/main/examples/mock/main.go) | Mock server usage |
| [`iterator/`](https://github.com/arielsrv/go-restclient/blob/main/examples/iterator/main.go) | Async/iterator pattern |
| [`problem/`](https://github.com/arielsrv/go-restclient/blob/main/examples/problem/main.go) | RFC 7807 problem details (auto-deserialized from `application/problem+json`) |
| [`metrics/`](https://github.com/arielsrv/go-restclient/blob/main/examples/metrics/main.go) | Prometheus metrics — starts an HTTP server on `:8081` |
| [`trace/`](https://github.com/arielsrv/go-restclient/blob/main/examples/trace/main.go) | OpenTelemetry tracing — starts an HTTP server on `:8081` |
...
MIT — see [LICENSE](https://github.com/arielsrv/go-restclient/blob/main/LICENSE) for details.
